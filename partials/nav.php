...
<nav>
    <ul>
        <?php if (is_logged_in()) : ?>
            ...
            <li><a href="<?php echo get_url('admin/cat_profile.php'); ?>">Cat Profile</a></li> <!-- example link for cat page -->
        <?php endif; ?>
        <?php if (!is_logged_in()) : ?>
        ...
        <?php if (has_role("Admin")) : ?>
            ...
            <li><a href="<?php echo get_url('admin/manage_cat_data.php'); ?>">Manage Cat Data</a></li> <!-- example link for cat page -->
        <?php endif; ?>
        <?php if (is_logged_in()) : ?>
